...
// prettier-ignore
/** @param {import("../mongo/uM_cooldowns").CooldownType} reminderType */
const reminder_ES = reminderType => new BetterEmbed({
    author: { text: "⏰ Reminder" },
    description: `Your \`${jt.toTitleCase(reminderType.replace("_", ""))}\` is **available**!`
});
